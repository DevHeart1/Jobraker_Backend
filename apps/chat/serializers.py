...
class ChatSessionListSerializer(serializers.ModelSerializer):
    ...
    last_message_preview = serializers.SerializerMethodField(
        help_text="A short preview of the last message in the session."
    )
...
class ChatSessionSerializer(serializers.ModelSerializer):
    ...
    messages = ChatMessageSerializer(
        many=True, read_only=True, help_text="Messages within this chat session."
    )
...
class SendMessageSerializer(serializers.Serializer):
    ...
    content = serializers.CharField(
        max_length=10000, help_text="The message content to send to the AI assistant"
    )
