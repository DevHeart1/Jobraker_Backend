...
router.register(
    r"alerts", views.JobAlertViewSet, basename="jobalert"
)  # Added JobAlertViewSet
...
urlpatterns = [
    ...
    path(
        "recommendations/",
        views.JobRecommendationsView.as_view(),
    ...
    path(
        "jobs/<uuid:job_id>/auto-apply/",
        views.AutoApplyView.as_view(),
        name="auto_apply_job",
    ),
