...
from .models import Application, Job, JobAlert, JobSource, SavedJob
...
class JobAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Employment Details", {"fields": ("job_type", "experience_level", "status")}),
        (
            "Salary Information",
            {
                "fields": (
        ...
        ("AI & Matching", {"fields": ("processed_for_matching",)}),
        ("Dates", {"fields": ("posted_date", "application_deadline")}),
        (
            "Statistics",
            {"fields": ("view_count", "application_count"), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
...
class JobSourceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "API Credentials",
            {"fields": ("api_key", "api_secret"), "classes": ("collapse",)},
        ),
        (
            "Statistics",
            {
