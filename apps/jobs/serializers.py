...
class ApplicationSerializer(serializers.ModelSerializer):
    ...
    job_id = serializers.UUIDField(
        write_only=True, help_text="UUID of the job to apply for"
    )
    ...
    class Meta:
        ...
        read_only_fields = (
            ...
            "updated_at",
            "match_score",
            "follow_up_reminder_sent_at",  # Added follow_up_reminder_sent_at
        )
...
class JobSearchSerializer(serializers.Serializer):
    ...
    title = serializers.CharField(
        required=False, max_length=200, help_text="Job title or keywords to search for"
    )
    company = serializers.CharField(
        required=False, max_length=100, help_text="Company name or partial match"
    )
    ...
    min_salary = serializers.IntegerField(
        required=False, min_value=0, help_text="Minimum salary requirement"
    )
    max_salary = serializers.IntegerField(
        required=False, min_value=0, help_text="Maximum salary range"
    )
    is_remote = serializers.BooleanField(
        required=False, help_text="Filter for remote work opportunities"
    )
...
class JobSearchResultSerializer(serializers.Serializer):
    ...
    next = serializers.URLField(
        required=False, allow_null=True, help_text="URL for next page"
    )
    previous = serializers.URLField(
        required=False, allow_null=True, help_text="URL for previous page"
    )
...
class JobRecommendationSerializer(serializers.Serializer):
    ...
    total_recommendations = serializers.IntegerField(
        help_text="Total number of available recommendations"
    )
    generated_at = serializers.DateTimeField(
        help_text="When recommendations were generated"
    )
...
class ApplicationStatsSerializer(serializers.Serializer):
    ...
    pending_applications = serializers.IntegerField(
        help_text="Applications waiting for response"
    )
    interview_requests = serializers.IntegerField(
        help_text="Number of interview requests received"
    )
    offers_received = serializers.IntegerField(
        help_text="Number of job offers received"
    )
    ...
    most_applied_job_type = serializers.CharField(
        help_text="Most frequently applied job type"
    )
    most_applied_location = serializers.CharField(
        help_text="Most frequently applied location"
    )
...
class SuccessResponseSerializer(serializers.Serializer):
    ...
    success = serializers.BooleanField(
        default=True, help_text="Operation success status"
    )
...
class ErrorResponseSerializer(serializers.Serializer):
    ...
    success = serializers.BooleanField(
        default=False, help_text="Operation success status"
    )
