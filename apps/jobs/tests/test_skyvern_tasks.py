...
from apps.integrations.tasks import (
    submit_job_application_with_skyvern,
    monitor_skyvern_application_status,
)
...
def test_submit_job_application_with_skyvern_success(mock_skyvern_service, user_with_profile, sample_job, job_application):
    ...
    with patch('apps.integrations.tasks.monitor_skyvern_application_status.delay') as mock_monitor:
...
@pytest.mark.django_db
@patch('apps.integrations.tasks.SkyvernService')
def test_submit_job_application_with_skyvern_failure(mock_skyvern_service, user_with_profile, sample_job, job_application):
...
@pytest.mark.django_db
@patch('apps.integrations.tasks.SkyvernService')
def test_monitor_skyvern_application_status_completed(mock_skyvern_service, job_application):
...
def test_monitor_skyvern_application_status_in_progress(mock_retry, mock_skyvern_service, job_application):
