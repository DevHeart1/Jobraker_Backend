...
class Command(BaseCommand):
        ...
        try:
            with connection.cursor() as cursor:
                ...
                for index in indexes:
                    self.stdout.write(f'Index: {index[0]}, Scans: {index[1]}, Tuples Read: {index[2]}')
    ...
    def cleanup_database(self, days: int, dry_run: bool):
        ...
        try:
            ...
            if dry_run:
                self.stdout.write(self.style.WARNING('DRY RUN - No actual cleanup performed'))
                ...
                self.stdout.write(self.style.SUCCESS(f'✅ Deleted {deleted_count} old documents'))
    ...
    def reindex_database(self):
        ...
        try:
            ...
            if success:
                ...
                self.stdout.write(self.style.WARNING('⚠️  Reindexing not available in development mode'))
    ...
    def backup_database(self):
        ...
        try:
            ...
            backup_filename = f"jobraker_backup_{datetime.now().strftime('%Y%m%d_%H%M%S')}.sql"
