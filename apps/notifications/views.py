                    ...
                    "notifications": [
                        {
                            ...
                            "data": {"job_count": 5, "alert_id": "alert_456"},
                        },
                        {
                            "id": "notif_124",
...
class NotificationViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        ...
        return Response(
            {"message": "Notification listing coming soon", "notifications": []}
        )
    ...
    def create(self, request):
        ...
        return Response({"message": "Notification creation coming soon"})
    ...
    def mark_read(self, request, pk=None):
        ...
        return Response(
            {"message": "Mark as read functionality coming soon", "notification_id": pk}
        )
    ...
    def mark_all_read(self, request):
        ...
        return Response({"message": "Mark all as read functionality coming soon"})
...
class NotificationSettingsView(APIView):
    ...
    def put(self, request):
        ...
        return Response({"message": "Notification settings update coming soon"})
...
@extend_schema(
    ...
    request=OpenApiExample(
        ...
        value={"type": "email", "message": "This is a test notification"},
    ),
    responses={
        200: OpenApiExample(
            "Test Sent",
    ...
    responses={
        200: OpenApiExample(
            ...
            value={
                ...
                "read_rate": 92.5,
                "delivery_stats": {
                    "email": {"sent": 180, "delivered": 175, "delivery_rate": 97.2},
                    "push": {"sent": 65, "delivered": 60, "delivery_rate": 92.3},
                },
                "type_breakdown": {
                    "job_alert": 85,
                ...
                "last_30_days": {"received": 45, "read": 38, "engagement_rate": 84.4},
            },
        ),
        401: OpenApiExample(
            "Unauthorized",
