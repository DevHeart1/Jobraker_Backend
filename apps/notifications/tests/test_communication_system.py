...
from apps.jobs.models import Job, JobAlert, Application
...
class ChatAPITestCase(APITestCase):
    ...
    def test_send_chat_message(self):
        ...
        data = {
            'content': 'Hello, can you help me with job searching?'
        }
...
class NotificationSignalTestCase(TestCase):
    ...
    def test_application_status_update_signal(self):
        ...
        with patch('apps.notifications.signals.send_application_status_update_task') as mock_task:
            mock_task.delay = MagicMock()
...
class CelerySchedulingTestCase(TestCase):
    ...
    def test_celery_beat_configuration(self):
        ...
        self.assertEqual(daily_alerts['task'], 'apps.notifications.tasks.process_daily_job_alerts')
        
        weekly_alerts = beat_schedule['process-weekly-job-alerts']
        self.assertEqual(weekly_alerts['task'], 'apps.notifications.tasks.process_weekly_job_alerts')
...
class CommunicationSystemIntegrationTestCase(TestCase):
    ...
    def test_complete_user_workflow(self):
        ...
        with patch('apps.notifications.signals.send_welcome_email_task') as mock_welcome:
        ...
        with patch('apps.notifications.signals.send_application_status_update_task') as mock_update:
        ...
        with patch('apps.notifications.tasks.EmailService.send_job_alert_email') as mock_alert:
